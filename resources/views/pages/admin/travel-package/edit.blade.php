        ...
        <div class="card shadow">
            <div class="card-body">
                <form action="{{ route('travel-package.update', $item->id) }}" method="post">
                    ...
                    <div class="form-group">
                        <label for="departure_date">Deprature Date</label>
                        <input type="date" class="form-control" name="departure_date" placeholder="Deprature Date" value="{{ $item->departure_date }}">
                    </div>
                    <div class="form-group">
